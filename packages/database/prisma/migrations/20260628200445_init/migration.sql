...
-- CreateEnum
CREATE TYPE "taskflow"."NotificationType" AS ENUM ('TASK_ASSIGNED', 'TASK_UPDATED', 'COMMENT_CREATED', 'MEMBER_INVITED');
...
CREATE TABLE "taskflow"."Notification" (
    ...
    "userId" UUID NOT NULL,
    "actorId" UUID,
    "type" "taskflow"."NotificationType" NOT NULL,
...
-- CreateIndex
CREATE INDEX "Notification_userId_read_idx" ON "taskflow"."Notification"("userId", "read");

-- CreateIndex
CREATE INDEX "Notification_userId_createdAt_idx" ON "taskflow"."Notification"("userId", "createdAt" DESC);
...
-- AddForeignKey
ALTER TABLE "taskflow"."Notification" ADD CONSTRAINT "Notification_userId_fkey" FOREIGN KEY ("userId") REFERENCES "auth"."User"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "taskflow"."Notification" ADD CONSTRAINT "Notification_actorId_fkey" FOREIGN KEY ("actorId") REFERENCES "auth"."User"("id") ON DELETE SET NULL ON UPDATE CASCADE;
